          ...
          <div className="-mx-4">
            <div className="flex snap-x snap-mandatory gap-4 overflow-x-auto px-4 pb-4">
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <Card className="h-full border-slate-600/50 bg-slate-800/80 shadow-lg backdrop-blur">
                    <CardContent className="flex h-full flex-col p-6">
                      <div className="mb-6 flex-1">
                        ...
                        <p className="italic leading-relaxed text-slate-300">"{testimonial.quote}"</p>
                      </div>
                      <div className="mb-4">
